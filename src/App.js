...
const style = {
  ...
  sectionContainer: `flex flex-col justify-between h-[64vh] w-[76vw] bg-gray-400 bg-opacity-15 shadow-xl border relative border-[1px] border-white border-opacity-15 rounded-[16px] max-md:mb-[4vh]`,
  Container: `relative`,
  ...
  nav: ``,
  buttonPosition: `absolute font-[600] top-0 right-0 h-[10vh] flex items-center justify-center py-4 pr-16 max-md:top-16 max-md:right-0 max-md:w-full max-md:pr-0`,
};
  ...
  return (
    <div className={style.appContainer}>
      ...
      <div className={style.chatContainer}>
        <div className="w-full h-full flex justify-center items-center max-md:items-end">
