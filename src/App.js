...
const style = {
  ...
  sectionContainer: `flex flex-col justify-between h-[64vh] w-[76vw] bg-[#626262] bg-opacity-[0.15] backdrop-blur-[150px] shadow-xl border relative border-[1px] border-white border-opacity-15 rounded-[16px] max-md:mb-[4vh]`,
  Container: `relative`,
  ...
  navBar: `w-full h-[10vh] flex justify-center items-center px-4 pt-16 absolute z-10 `,
  heading: `text-3xl text-[#E5E5E5] font-bold tracking-[0.5px]`,
  nav: ``,
  buttonPosition: `absolute font-[600] top-0 right-0 h-[10vh] flex items-center justify-center my-2 pr-16 max-xl:pr-12 max-md:h-[7vh] max-sm:pr-3 `,
};
    ...
    <div className={style.appContainer}>
      ...
      <div className={style.chatContainer}>
        <div className="w-full flex flex-col items-center justify-center">
          ...
          <h2 className="text-[#E5E5E5] font-[Montserrat] font-400 leading-6	mt-[28px] max-md:text-[14px] max-sm:text-[12px]">
